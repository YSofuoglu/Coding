...
(7 + 4 + 0 + 5 + 6 + 2 + 6 + 10 + 7) = 47 / 9 = 5.2222 = 5. The other three integers are obtained the same way, then the
...
'''
def f(m):
    return [[sum(m[i+x][j+y] for x in range(-1, 2) for y in range(-1, 2)) // 9
